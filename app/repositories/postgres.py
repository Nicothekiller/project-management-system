...
from app.domain.priority import BugPriority, ChorePriority, FeaturePriority
...
class PostgresProjectRepo:
    ...
    def add(self, project: Project) -> None:
        modelo = ProjectModel(id=project.id, name=project.name)
...
def _strategy_from_type(task_type: str):
    ...
    raise ValueError("task_type invalido")
...
class PostgresTaskRepo:
    ...
    def add(self, task: Task) -> None:
        # el tipo de tarea necesita persistencia; inferir de la clase estrategia
